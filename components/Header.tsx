...
export default function Header() {
  ...
  return (
    <header className={`header-area2 style-2 two ${isSticky ? "sticky" : ""}`}>
      ...
      <div className={`main-menu ${isMobileMenuOpen ? "show-menu" : ""}`}>
        ...
        <div className="d-lg-none d-block">
          <form className="mobile-menu-form" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="header-btn5">
            <Link className="primary-btn3" href="#contact" onClick={closeMobileMenu}>
              Get A Quote
            </Link>
          </div>
        </div>
      ...
      <div className="nav-right d-flex jsutify-content-end align-items-center">
        ...
        <div
          className={`sidebar-button mobile-menu-btn ${isMobileMenuOpen ? "active" : ""}`}
