...
export default function WhyChooseUs() {
  return (
    <div className="home6-choose-section sec-mar" id="about">
            ...
            <div className="row">
              ...
              <div className="col-lg-6">
                <div className="choose-right-img magnetic-item">
                  <img className="img-fluid" src="/assets/img/home-6/choose-img-1.png" alt="Why Choose Us" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="row g-lg-4 gy-5">
              <div className="col-lg-7">
                <div className="choose-left-content">
                  ...
                  <p>
                    Morbi interdum pellentesque nunc, luctus pretium nullagoneq luctus at. Aliquam
                    cursus nunc arcu, condimentum efficiturunt tellus iaculis faucibus Quisque
                    gravida.
                  </p>
                  <div className="sl">
                    <h2>#1</h2>
                    ...
                    <li>
                      <div className="single-feature">
                        ...
                        <div className="content">
                          <h4>Strategy</h4>
                          <p>
                            Morbi interdum pellentesque nunc, luctuso pretium nullagoneq
                            luctus at. Aliquam one cursus nunc arcu
                          </p>
                        </div>
                      </div>
                    </li>
